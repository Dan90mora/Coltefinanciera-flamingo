...
router.post("/seguros/whatsapp", async (req, res) => {
    ...
    try {
        ...
        if (!chatOn) {
            ...
            console.log("✅ ¿Pasará a audio?:", responseMessage.length <= 400 &&
                ...
                !/\b[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Z|a-z]{2,}\b/.test(responseMessage) &&
                isAvailableForAudio);
            console.log('=====================================');
            ...
            if (responseMessage.length <= 400 && // Menor a 400 caracteres
                ...
                !/\b[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Z|a-z]{2,}\b/.test(responseMessage) && // 🚫 NUEVA CONDICIÓN: No contiene emails
...
router.post('/seguros/chat-dashboard', async (req, res) => {
